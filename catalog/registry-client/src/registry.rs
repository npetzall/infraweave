...
mod tests {
    ...
    #[test]
    fn resolve_providers_v1_absolute_passes_through() {
        assert_eq!(
            Registry::resolve_providers_v1_base(
    ...
    #[test]
    fn resolve_providers_v1_invalid_registry_host_fails_origin_parse() {
        let err = Registry::resolve_providers_v1_base("providers/", "bad host").unwrap_err();
        assert!(matches!(err, ProviderRegistryError::InvalidBaseUrl(_)));
    }
